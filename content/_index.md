...
I am a Software Engineer with a Masters degree in Computer Science (Robotics). During my graduate studies, I worked at [Stanford Vision Lab](https://sujaygarlanka.com/experience/svl/) developing action primitives for robots (pick, place, navigate, etc.) on NVIDIA's Omniverse simulation environment using both algorithmic and distributed RL approaches. 
My worked focused on both engineering for speed via implementing fast collision detection in simulation for the algorithmic primitives and parallelizable/distributed environments for RL training as well as for the efficacy of the primitives. 
